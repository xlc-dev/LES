...
<svelte:head>
  ...
  <script
    src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.36.5/ace.min.js"
  ></script>
</svelte:head>
...
{#snippet msg()}
  <div class="mx-auto max-w-2xl p-8">
    <img
      ...
      class="w-75 mx-auto rounded-lg"
      alt="LES Logo"
    />
    <h1 class="pt-4 text-center text-4xl font-bold">
      Local Energy System Simulation
    </h1>
    <p class="py-4 text-center text-lg">
      Welcome to the LES Research application. You can determine the efficiency
      of algorithms and cost models by creating your own simulations. Please
      continue with the following steps to set up the environment you would like
      to research.
    </p>
    <button
      onclick={() => {
    ...
    <p class="py-4 text-center text-sm">
      This platform is developed for the UNESCO Chair of AI & DS for Society of
...
{#snippet choices()}
  <div class="mx-auto max-w-2xl p-8">
    ...
    <p class="py-4 text-center text-lg">
      Please select the simulation you would like to run.
    </p>
    ...
    <div class="flex flex-col gap-4 py-4">
      <button
        ...
        class="bg-blue-500 text-white px-4 py-2 rounded-lg transition-colors duration-200 hover:bg-blue-600"
      >
        Single
      </button>
      <button
...
<main class="min-h-screen text-white bg-les-gray-500">
